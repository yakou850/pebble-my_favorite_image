...
Pebble.addEventListener('webviewclosed', function(e) {
	...
	var imageURL2 = configData['imageURL2'];
	var imageURL3 = configData['imageURL3'];
	var imageURL4 = configData['imageURL4'];
	var imageURL5 = configData['imageURL5'];

	var dict = {};
	dict['KEY_IMAGE_URL1']= imageURL1;
	dict['KEY_IMAGE_URL2'] = imageURL2;
	dict['KEY_IMAGE_URL3'] = imageURL3;
	dict['KEY_IMAGE_URL4'] = imageURL4;
	dict['KEY_IMAGE_URL5'] = imageURL5;
